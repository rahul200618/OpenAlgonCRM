...
import { importContacts } from "@/actions/crm/contacts/import-contacts";
...
const ImportContactsModal = () => {
  ...
  const handleImport = async () => {
    ...
    try {
      const { imported, skipped, errors } = await importContacts(formData);
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            {step === "upload" && "Select a CSV file to import contacts."}
          ...
          <div className="space-y-3 py-2">
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground pt-1">
                  <span className="text-destructive">*</span> Last Name is required.
                </p>
              </div>
          </div>
        )}
