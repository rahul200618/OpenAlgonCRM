...
```bash
cd /Users/rahul200618/development/openalgoncrm && pnpm tsc --noEmit
```
...
```bash
cd /Users/rahul200618/development/openalgoncrm && grep -n "websiteInvalid" messages/*.json
```
...
```bash
cd /Users/rahul200618/development/openalgoncrm && git add app/[locale]/\(routes\)/crm/accounts/components/NewAccountForm.tsx messages/ && git commit -m "refactor(crm): relax NewAccountForm validation to require only name"
```
...
```bash
cd /Users/rahul200618/development/openalgoncrm && grep -n "formSchema\|z.object\|z.string" "app/[locale]/(routes)/crm/accounts/components/UpdateAccountForm.tsx" | head -40
```
...
```bash
cd /Users/rahul200618/development/openalgoncrm && git add "app/[locale]/(routes)/crm/accounts/components/UpdateAccountForm.tsx" && git commit -m "refactor(crm): relax UpdateAccountForm validation to require only name"
```
...
```bash
cd /Users/rahul200618/development/openalgoncrm && grep -n "crm/account.saved" actions/crm/accounts/
```
...
```bash
cd /Users/rahul200618/development/openalgoncrm && pnpm lint && pnpm tsc --noEmit
```
...
```bash
cd /Users/rahul200618/development/openalgoncrm && git log --oneline dev..HEAD && git diff dev..HEAD --stat
```
...
```bash
cd /Users/rahul200618/development/openalgoncrm && git push -u origin HEAD
```
